$(function () {
	...
	$(".discont__date span").text(getDate(2));
	...
	cardSliderInit(".card__1 .card__slider")
	cardSliderInit(".card__2 .card__slider")
	cardSliderInit(".card__3 .card__slider")
	...
	switchColor(".card__2 .color")
	switchColor(".card__3 .color")
