$(function () {
	...
	function cardImage(selector) {
		function switchBtn(color) {
			var boot1 = $(selector + " .card__boot-1").attr("data-" + color);
			var boot2 = $(selector + " .card__boot-2").attr("data-" + color);
			
			$(selector + " .card__boot-1").hide().attr("src", boot1).fadeIn(500)
			$(selector + " .card__boot-2").hide().attr("src", boot2).fadeIn(500)
