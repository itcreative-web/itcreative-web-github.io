var landingFunctions = {
	...
	initLibraris: function() {
		...
		// var owl = $(".info__slider").owlCarousel({
		// 	loop: true,
		// 	nav : false,
		// 	dots: true,
		// 	dotsEach: true,
		...
		// 	let currentSlide = $(event.relatedTarget.$stage.children()[currentIndex]).find(".info__slide").data("slide"); 
		// 	// console.log(currentSlide)

		// 	$(".info__nav-btn").removeClass("active")
		// 	$(".info__nav-btn").each(function() {
