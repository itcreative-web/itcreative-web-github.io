$(function () {
	...
	function modal() {
		...
		$(".modal").click( function(e) {
			...
			if(target.classList.contains("modal__close")) {
				close()
				document.querySelector(".video__wrapper iframe").contentWindow.postMessage('{"event":"command","func":"stopVideo","args":""}', '*');
			}
	...
	function sizeBtns(selector) {
		$(selector + " .card__size-btn").click(function() {
			...
			$(selector + " .card__btn-block").removeClass("active")
