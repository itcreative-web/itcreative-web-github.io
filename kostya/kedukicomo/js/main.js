$(function () {
	...
	function initialCardSlider(selector, btnsSelector) {
		$(selector).slick({
			...
			autoplay: true,
			autoplaySpeed: 2000,
			prevArrow: $(btnsSelector + " .btn-prev"),
			nextArrow: $(btnsSelector + " .btn-next"),
		})
	}

	initialCardSlider(".card__1 .card__slider", ".card__1 .card__slider-btns" )
	initialCardSlider(".card__2 .card__slider", ".card__2 .card__slider-btns" )
	initialCardSlider(".card__3 .card__slider", ".card__3 .card__slider-btns" )
