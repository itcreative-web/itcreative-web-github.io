$(function () {
	function animations(selector, animationName) {
	...
	animations(".main__block-img1", "fadeIn")
	animations(".main__block-img2", "fadeIn")
	animations(".main__block-img3", "fadeIn")
	animations(".main__block-img4", "fadeIn")
	animations(".main__block-img5", "fadeIn")
