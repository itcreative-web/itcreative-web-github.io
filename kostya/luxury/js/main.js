$(function () {
	...
	function initCardSlider(selector) {
		var mainSlider = selector + ' .card__slider'
		var navSlider = selector + ' .card__slider-nav'
	...
	initCardSlider(".card__3")
	initCardSlider(".card__4")
	initCardSlider(".card__5")
	initCardSlider(".card__6")
	initCardSlider(".card__7")
	initCardSlider(".card__8")
	initCardSlider(".card__9")
	initCardSlider(".card__10")
	initCardSlider(".card__11")
	...
	$(".js-actual-date").each(function (index, item) {
        $(item).html(endDifDate($(item).data("date")));
    });
