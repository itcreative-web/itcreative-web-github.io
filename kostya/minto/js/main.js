$(function () {
	...
	addVideoOnPage(".video__wrapper-1");
	addVideoOnPage(".video__wrapper-2");
	addVideoOnPage(".video__wrapper-3");
	addVideoOnPage(".video__wrapper-4");
	addVideoOnPage(".video__wrapper-5");
})
