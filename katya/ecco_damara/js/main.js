...
$(document).ready(function () {
    ...
    responsive: [{
      ...
      settings: {
        ...
        customPaging: function customPaging(slider, i) {
          return '<button class="slider__dots"></button>';
        },
        arrows: true,
        appendArrows: $('.gallery'),
        prevArrow: '<div class="slider-btn gallery__prev">&#8592;</div>',
        nextArrow: '<div class="slider-btn gallery__next">&#8594;</div>'
      }
    }]
  }); // SLIDER REWIEV
  ...
  $('.rewiev__slider').slick({
    ...
    prevArrow: '<div class="slider-btn rewiev__prev">&#8592;</div>',
    nextArrow: '<div class="slider-btn rewiev__next">&#8594;</div>',
    responsive: [{
      breakpoint: 1681,
      settings: {
        slidesToShow: 2
      ...
      settings: {
        slidesToShow: 2,
        appendArrows: $('.rewiev__bottom_mobile'),
        prevArrow: '<div class="slider-btn rewiev__prev">&#8592;</div>',
        nextArrow: '<div class="slider-btn rewiev__next">&#8594;</div>',
        dots: true,
        appendDots: $('.rewiev__btn-wrapper'),
        customPaging: function customPaging(slider, i) {
          return '<button class="slider__dots"></button>';
        }
      }
  ...
  $("#shoe-white").click(function (event) {
    ...
    $("#shoe-black").removeClass("active-color"); // $(".color-name").text("Белый");
  ...
  $("#shoe-black").click(function (event) {
    ...
    $("#shoe-white").removeClass("active-color"); // $(".color-name").text("Черный");
  ...
  $("#shoe-brown").click(function (event) {
    ...
    $("#shoe-black2").removeClass("active-color"); // $(".color-name1").text("Желтый");
  ...
  $("#shoe-black2").click(function (event) {
    ...
    $("#shoe-brown").removeClass("active-color"); // $(".color-name1").text("Черный");
